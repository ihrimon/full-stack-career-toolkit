...
**⚫ Phase 4 — Modern React & Deployment**
...
- [x] Rules of Hooks — the _why_, not just the _what_
...
- [ ] Debugging _why_ a specific component re-rendered
...
_(For a full Next.js-specific deep dive, see [`NextJS/`](../NextJS).)_
...
- [ ] Explain _why_ a component re-rendered and fix it
